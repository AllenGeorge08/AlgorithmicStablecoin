...
pub struct RedeemCollateralAndBurnTokens<'info> {
    ...
    #[account(
        ...
        has_one = mint_account,  //it's using the correct mint constraint..
    )]
...
pub fn process_redeem_collateral_and_burn_tokens(
    ...
    //e Reducing the lamport balance
    ...
    //e Checking the health factor of the collateral to check if the collateral is undercollateralized or not...
    check_health_factor(
